...
export const IconCheck: FC<{ width?: number; height?: number; color?: string }> = ({
	width = 7.25,
	height = 5,
	color = 'white',
}) => {
	return (
		<svg width={width} height={height} viewBox={'0 0 11 9'}>
			<path fill="none" stroke={color} strokeWidth="2" d="M1 4.304L3.696 7l6-6" />
		</svg>
	);
};
